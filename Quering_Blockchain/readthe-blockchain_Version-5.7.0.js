...
const provider = new ethers.providers.JsonRpcProvider(`"HTTPS_API_KEY- of infura"`);
...
const checkBalance = await provider.getBalance('Account Address');
...
console.log("the account balance in Ethers : ",balanceEthers);
